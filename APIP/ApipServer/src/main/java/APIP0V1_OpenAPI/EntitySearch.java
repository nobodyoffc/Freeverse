...
@WebServlet(name = ApipApiNames.ENTITY_SEARCH, value = "/"+ ApipApiNames.ENTITY_SEARCH +"/"+ ApipApiNames.VER_1)
public class EntitySearch extends HttpServlet {
    ...
    protected void doRequest(HttpServletRequest request, HttpServletResponse response, AuthType authType) {
        ...
        // Request
        fcHttpRequestHandler.doSearchRequest(indexName, entityClass, defaultSortList, request, response, authType);
    }
