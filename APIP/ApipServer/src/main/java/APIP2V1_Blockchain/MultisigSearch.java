...
@WebServlet(name = ApipApiNames.MULTISIG_SEARCH, value = "/"+ ApipApiNames.SN_2+"/"+ ApipApiNames.MULTISIG_SEARCH +"/"+ ApipApiNames.VER_1)
public class MultisigSearch extends HttpServlet {
    private final FcHttpRequestHandler fcHttpRequestHandler;

    public MultisigSearch() {
