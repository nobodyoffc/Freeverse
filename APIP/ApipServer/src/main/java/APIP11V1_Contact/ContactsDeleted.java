...
public class ContactsDeleted extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        FcdslRequestHandler.doSearchRequest(Initiator.sid,IndicesNames.CONTACT, Contact.class, null,null,ACTIVE,TRUE,defaultSort, request,response,authType,Initiator.esClient,Initiator.jedisPool, Initiator.sessionHandler);
    }
    @Override
