...
@WebServlet(name = ApipApiNames.SHA_256_X_2_HEX, value = "/"+ ApipApiNames.SN_17+"/"+ ApipApiNames.VERSION_1 +"/"+ ApipApiNames.SHA_256_X_2_HEX)
public class Sha256x2Hex extends HttpServlet {
    ...
    protected void doRequest(HttpServletRequest request, HttpServletResponse response, AuthType authType, Settings settings) {
        ...
        replier.replySingleDataSuccessHttp(Hex.toHex(Hash.sha256x2(textBytes)),response);
    }
}