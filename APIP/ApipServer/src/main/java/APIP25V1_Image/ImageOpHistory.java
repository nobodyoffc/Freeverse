...
@WebServlet(name = ApipApiNames.IMAGE_OP_HISTORY, value = "/"+ ApipApiNames.SN_25+"/"+ ApipApiNames.IMAGE_OP_HISTORY +"/"+ ApipApiNames.VER_1)
public class ImageOpHistory extends HttpServlet {
