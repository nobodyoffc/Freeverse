...
//                Objects.equals(this.multisign, that.multisign) &&
...
//    @Override
//    public int hashCode() {
//        return Objects.hash(Arrays.hashCode(rawTx), multisign, cashList, fidSigMap);
//    }
//
//    @Override
...
//                "p2SH=" + JsonUtils.toNiceJson(multisign) + ", \n" +
...
//        if (multisign != null) dataMap.put("p2SH", multisign);
