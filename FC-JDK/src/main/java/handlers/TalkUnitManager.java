...
public class TalkUnitManager extends Manager<TalkUnit> {
    ...
    public TalkUnitManager(Settings settings) {
        super(settings, ManagerType.TALK_UNIT, LocalDB.SortType.UPDATE_ORDER, TalkUnit.class, true, false);
