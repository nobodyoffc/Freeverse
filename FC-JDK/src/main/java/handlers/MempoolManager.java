...
public class MempoolManager extends Manager<FcEntity> {
    private static final Logger log = LoggerFactory.getLogger(MempoolManager.class);
    ...
    public MempoolManager(NaSaRpcClient nasaClient, ApipClient apipClient,
                          ElasticsearchClient esClient, String listenPath) {
        super(ManagerType.MEMPOOL);
    ...
    public MempoolManager(Settings settings) {
        super(settings, ManagerType.MEMPOOL);
    ...
    public void checkMempool() {
        try {
            ...
            log.error("Error checking mempool: {}", e.getMessage());
        }
    }
