...
public class HatManager extends Manager<Hat> {
    // Constants
    ...
    public HatManager(Settings settings) {
        super(settings, ManagerType.HAT, LocalDB.SortType.UPDATE_ORDER, Hat.class, true, false);
