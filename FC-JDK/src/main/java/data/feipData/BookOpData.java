...
public class BookOpData {
	...
	static {
		...
		OP_FIELDS.put(Op.UPDATE.toLowerCase(), new String[]{FieldNames.BOOK_ID, FieldNames.TITLE,  FieldNames.DID, FieldNames.LANG, FieldNames.AUTHORS, FieldNames.SUMMARY});
		OP_FIELDS.put(Op.DELETE.toLowerCase(), new String[]{FieldNames.BOOK_IDS});
		OP_FIELDS.put(Op.RECOVER.toLowerCase(), new String[]{FieldNames.BOOK_IDS});
		OP_FIELDS.put(Op.RATE.toLowerCase(), new String[]{FieldNames.BOOK_ID, FieldNames.RATE});
	}
