...
//    public static final String ToolsPath = "/tools/";
    ...
    static {
        ...
        apiList.addAll(java.util.List.of(openAPIs));
        apiList.addAll(java.util.List.of(blockchainAPIs));
        apiList.addAll(java.util.List.of(identityAPIs));
        apiList.addAll(java.util.List.of(organizeAPIs));
