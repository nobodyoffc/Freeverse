...
public class ServiceData {
	...
	static {
		OP_FIELDS.put(Op.PUBLISH.toLowerCase(), new String[]{"stdName", "localNames", "desc", "ver", "urls", "waiters", "protocols", "codes", "services", "params"});
		OP_FIELDS.put(Op.UPDATE.toLowerCase(), new String[]{"sid", "stdName", "localNames", "desc", "ver", "urls", "waiters", "protocols", "codes", "services", "params"});
		OP_FIELDS.put(Op.STOP.toLowerCase(), new String[]{"sids"});
		OP_FIELDS.put(Op.CLOSE.toLowerCase(), new String[]{"sids", "closeStatement"});
		OP_FIELDS.put(Op.RECOVER.toLowerCase(), new String[]{"sids"});
		OP_FIELDS.put(Op.RATE.toLowerCase(), new String[]{"sid", "rate"});
	}
	...
	public static ServiceData makePublish(String stdName, String[] localNames, String desc, 
	...
	public static ServiceData makeUpdate(String sid, String stdName, String[] localNames, 
	...
	public static ServiceData makeStop(List<String> sids) {
		ServiceData data = new ServiceData();
	...
	public static ServiceData makeClose(List<String> sids, String closeStatement) {
		ServiceData data = new ServiceData();
	...
	public static ServiceData makeRecover(List<String> sids) {
		ServiceData data = new ServiceData();
	...
	public static ServiceData makeRate(String sid, Integer rate) {
		ServiceData data = new ServiceData();
