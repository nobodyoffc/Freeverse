...
public class AppData {
	...
	static {
		OP_FIELDS.put(Op.PUBLISH.toLowerCase(), new String[]{"stdName", "localNames", "desc", "types", "urls", "downloads", "waiters", "protocols", "codes", "services"});
	...
	public static AppData makeStop(List<String> aids) {
		AppData data = new AppData();
	...
	public static AppData makeClose(List<String> aids, String closeStatement) {
		AppData data = new AppData();
	...
	public static AppData makeRecover(List<String> aids) {
		AppData data = new AppData();
