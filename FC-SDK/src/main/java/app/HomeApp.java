...
public class HomeApp extends FcApp {
    ...
    public static void showPriKeyInfo(BufferedReader br, byte[] priKey) {
        ...
        System.out.println("* PriKey WIF compressed:" + KeyTools.priKey32To38(priKey32));
    ...
    public static void multiSignTx(Settings settings) {
        ...
        while (true) {
            ...
            System.out.println(TxCreator.signSchnorrMultiSignTx(multiSignDataJson, priKey, FchMainNetwork.MAINNETWORK));
    ...
    public static void createFid(ApipClient apipClient, BufferedReader br) {
        ...
        do {
            List<Cid> cidList = apipClient.searchCid(br);
