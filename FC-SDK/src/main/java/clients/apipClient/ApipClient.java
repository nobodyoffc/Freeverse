...
//Organize
    ...
    public List<Contact> freshContactSinceTime(String myFid, Long lastHeight, Integer size, final List<String> last, Boolean active) {
        Fcdsl fcdsl = new Fcdsl();
    ...
    public List<Secret> freshSecretSinceTime(String myFid, Long lastHeight, Integer size, List<String> last, Boolean active) {
        Fcdsl fcdsl = new Fcdsl();
    ...
    public List<Mail> freshMailSinceTime(String myFid, long lastHeight, Integer defaultRequestSize, List<String> last, Boolean active) {
        Fcdsl fcdsl = new Fcdsl();
        fcdsl.setIndex(MAIL);
        String heightStr = String.valueOf(lastHeight);
        fcdsl.addNewQuery().addNewRange().addNewFields(LAST_HEIGHT).addGt(heightStr);
