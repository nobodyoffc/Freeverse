...
//        return result;
     ...
     */
    private static List<feip.feipData.Secret> createTestSecrets(int count) {
        List<feip.feipData.Secret> secrets = new ArrayList<>();
        
        for (int i = 0; i < count; i++) {
            feip.feipData.Secret secret = new feip.feipData.Secret();
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Initialize the DB
            LevelDB<feip.feipData.Secret> db = new LevelDB<>(SortType.NO_SORT, feip.feipData.Secret.class);
            ...
            System.out.println("Secret: " + secret.getId() + " -> " + 
                              ((feip.feipData.Secret)deserializedSecret).getId() + 
                              " (Equal: " + secret.getId().equals(((feip.feipData.Secret)deserializedSecret).getId()) + ")");
