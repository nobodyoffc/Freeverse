...
public class Session {
    ...
    public static Session getSessionFromJedis(String sid, String pubKey, Jedis jedis, String fid, long sessionDays) {
        jedis.select(0);
        ...
        if (sessionKey != null) {
            ...
            try {
                session = Session.makeSession(sid, jedis, fid, sessionDays);
            } catch (Exception e) {
