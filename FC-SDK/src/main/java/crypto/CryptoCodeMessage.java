...
public class CryptoCodeMessage {
    ...
    public static final int PUBKEY_PRIKEY_DIFFERENT_PAIRS = 19;
    ...
    public static String getMessage(int code) {
        ...
        codeMsgMap.put(PUBKEY_PRIKEY_DIFFERENT_PAIRS, "The pubKey and priKey have to be from different key pairs.");
