...
public class Bitcore {
    ...
    public static byte[] decrypt(byte[] encbuf, PrivateKey privateKey) throws Exception {
        ...
        if (!NO_KEY) {
            ...
            switch (encbuf[0]) {
                ...
                case 2:
                    ...
                    break;
                default:
                    throw new Error("Invalid public key type: " + encbuf[0]);
            }
        ...
        // Debug output
        System.out.println("Decryption kM: " + Hex.toHexString(kM));
        System.out.println("Decryption HMAC input: " + Hex.toHexString(ciphertext));
        System.out.println("Received HMAC: " + Hex.toHexString(d));
        System.out.println("Calculated HMAC: " + Hex.toHexString(d2));
    ...
    public static PrivateKey createPrivateKey(byte[] privateKeyBytes) throws Exception {
    ...
    private static void testDecryhptCipherFromFreeSignV1() throws Exception {
        String cipher = "A1f7bKbSMYNVvfgTGY8yf+bD4RQEzouTnkJB7bDNRc1zZCYWTy+duQECOa+CMhkB7PVua6YAFm1UQdTsHRIML/ehzdic3tn+Vm11IMsuE0j6dgoiZMcja0fcRJifSieKqA==";//"A4MF+Ys1rHRaZ3bcZ68rz9GA2Qdh1/x8bGSFQyzWAkRfV9Ks0d4Mm1AQ5eTn1Uj/3O4MPD85uJHlBZ9uV5x8YYhU+hb/";
        ...
        byte[] decrypted = decrypt(cipherBytes, privateKey);
        System.out.println("Decrypted: " + new String(decrypted));
    }
}