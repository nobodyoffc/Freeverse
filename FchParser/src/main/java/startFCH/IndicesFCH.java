...
public class IndicesFCH {
	public static void createAllIndices(ElasticsearchClient esClient) throws ElasticsearchException {
		...
		String multisignJsonStr = "{\"mappings\":{\"properties\":{\"id\":{\"type\":\"wildcard\"},\"redeemScript\":{\"type\":\"keyword\"},\"m\":{\"type\":\"short\"},\"n\":{\"type\":\"short\"},\"pubkeys\":{\"type\":\"keyword\"},\"fids\":{\"type\":\"wildcard\"},\"birthHeight\":{\"type\":\"long\"},\"birthTime\":{\"type\":\"long\"},\"birthTxId\":{\"type\":\"keyword\"}}}}";
		EsUtils.createIndex(esClient, IndicesNames.MULTISIGN, multisignJsonStr);
	}
	...
	public static void deleteAllIndices(ElasticsearchClient esClient) throws ElasticsearchException, IOException {
		...
		EsUtils.deleteIndex(esClient, IndicesNames.MULTISIGN);
	}	
}
