...
//        super(settings, HandlerType.SECRET, LocalDB.SortType.UPDATE_ORDER, FcEntity.SimpleFcSerializer.getSerializer(SecretDetail.class), SecretDetail.class, true, LocalDB.DbType.LEVEL_DB);
...
//        createMap(testMapName, FcEntity.SimpleSerializer.getSerializer(String.class));
//        putInMap(testMapName, "test_key", "test_value", FcEntity.SimpleSerializer.getSerializer(String.class));
//        String retrievedValue = getFromMap(testMapName, "test_key", FcEntity.SimpleSerializer.getSerializer(String.class));
