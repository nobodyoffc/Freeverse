...
public class MailHandler extends Handler {
    ...
    public void menu() {
        ...
        menu.add(OpNames.READ, () -> readMails(br));
        menu.add(OpNames.UPDATE, () -> checkMail(br));
    ...
    private void deleteInvalidMails(BufferedReader br) {
        ...
        if(! Inputer.askIfYes(br,"Found "+failedDecryptMailIdList.size()+"invalid mails. Delete them?")){
            return;
        }
    ...
    public void readMails(BufferedReader br) {
        ...
        while (true) {
            ...
            String op = Inputer.chooseOne(
                    new String[]{OpNames.READ,MailOp.DELETE.toLowerCase()},
