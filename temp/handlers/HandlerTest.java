...
//        System.out.println("\nTesting Handler with " + sortType + " sort type...");
//
//        // Create handler instance
//        Handler<TestEntity> handler = new Handler<>(
//            settings,
//            Handler.HandlerType.TEST,
//            sortType,
//            new FcEntity.SimpleFcSerializer<>(TestEntity.class),
//            TestEntity.class,
//            true,
//                LocalDB.DbType.LEVEL_DB);
//
//        try {
...
//            handler.createMap("test_map", FcEntity.SimpleSerializer.getSerializer(String.class));
//            handler.putInMap("test_map", "key1", "value1", FcEntity.SimpleSerializer.getSerializer(String.class));
//            String mapValue = handler.getFromMap("test_map", "key1", FcEntity.SimpleSerializer.getSerializer(String.class));
...
//            handler.putMeta("test_meta", "meta_value");
//            Object metaValue = handler.getMeta("test_meta");
