...
class ServerThread extends Thread {
    ...
    public ServerThread(Socket socket, byte[] accountPriKey, Map<String,Long> nPriceMap, Service service, TalkServerSettings settings, ApipClient apipClient, JedisPool jedisPool) {
        this.socket = socket;
    ...
    public void run() {
        ...
        try(OutputStreamWriter outputStreamWriter = new OutputStreamWriter(socket.getOutputStream());
            ...
            sendServiceInfo(outputStreamWriter);
            ...
            while (true) {
                ...
                try {
                    ...
                    replyEncrypted(talkParams.getDealer(), TransferUnit.ToType.FID, userFid, outputStreamWriter, ReplyCodeMessage.Code1020OtherError, null,"No TalkItem object.", null,false);
