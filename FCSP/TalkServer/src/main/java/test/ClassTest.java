...
import static fcData.TalkUnit.fromBundle;
...
public class ClassTest {
    ...
    public void test(){
        ...
        talkUnit.setToType(TalkUnit.ToType.GROUP_LIST);
        ...
        System.out.println(Hex.toHex(talkUnit.getBytes()));

        TalkUnit talkUnit1 = fromBundle(talkUnit.getBytes());
        ...
        talkUnit1 = fromBundle(talkUnit.getBytes());
        System.out.println(talkUnit1.toNiceJson());
